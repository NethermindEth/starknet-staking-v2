module github.com/NethermindEth/starknet-staking-v2
...
require (
	...
	github.com/NethermindEth/starknet.go v0.12.1-0.20250911104407-1eea098b0722 // starknet.go v0.12 + reorg fix
